...
public class ShareButtonBehavior : UIButtonBehavior {
	public GameObject shareModal;
	...
	public override void OnButtonUp (RaycastHit hit) {
		...
		shareModal.transform.parent = ReviewSphereBehavior.openSphere.transform.parent;
		shareModal.SetActive(true);
	}
}